...
translate arabic strings:
    ...
    new "اختر يد التحكم التي ترغب في معايرتها"
    ...
    new "يتم الآن معايرة [name] ([i]/[total])"

    # 00gamepad.rpy:58
    old "Press or move the [control!r] [kind]."
    new "اضغط او حرك [control!r] [kind]."
    ...
    new "ينسخ محتويات ملف traceback.txt إلى الحافظة."
    ...
    new "ينسخ محتويات ملف errors.txt إلى الحافظة."
